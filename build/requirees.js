(function () {
    ...
    function _doesCurrentTagMatchesCurrentDefine(currentTag) {
      ...
      var currentSource = currentTag.src;
      var urls = (_currentTag$versionty = currentTag.versiontype) === null || _currentTag$versionty === void 0 ? void 0 : _currentTag$versionty.urls;

      if (urls instanceof Array) {
        for (var i = 0; i < urls.length; i++) {
          var url = urls[i].replace(constants.reRelativePath, '');
      ...
      _createClass(RegistryAttributes, [{
        ...
        value: function _splitPackageConfigObjectIntoFiles(packageName, obj) {
          ...
          var version = obj.version,
              ...
              factory = obj.factory,
              preventReregistration = obj.preventReregistration;
        ...
        key: "_addFile",
        value: function _addFile(packageName, url, version, type, dependencies, factory, preventReregistration) {
          if (packageName) {
            ...
            this.files.push({
              ...
              factory: factory,
              preventReregistration: preventReregistration
            });
          }
        }
      }, {
    ...
    var _default$4 = /*#__PURE__*/function () {
      ...
      _createClass(_default, [{
        ...
        key: "_allowRegister",
        value: function _allowRegister(registrationFile) {
    ...
    var _default$2 = /*#__PURE__*/function () {
      ...
      _createClass(_default, [{
        ...
        key: "_getDownloadUrl",
        value: function _getDownloadUrl(configuredUrl) {
          var baseUrl = this._getBaseUrl();

          var applyBaseUrl = baseUrl && !constants.reIsAbsoluteUrl.test(configuredUrl);
          return applyBaseUrl ? new URL(configuredUrl, baseUrl).href : configuredUrl;
        }
      }, {
        key: "_getBaseUrl",
        value: function _getBaseUrl() {
          var _this$requireContext, _this$requireContext$;

          return (_this$requireContext = this.requireContext) === null || _this$requireContext === void 0 ? void 0 : (_this$requireContext$ = _this$requireContext.options) === null || _this$requireContext$ === void 0 ? void 0 : _this$requireContext$.baseUrl;
        }
      }, {
        key: "_loadFromUrl",
        value: function _loadFromUrl(version, type) {
          ...
          if (typeof loader === 'function') {
            ...
            if (index < urls.length) {
              var url = this._getDownloadUrl(urls[index]);

              try {
                return this._waitForPreLoadDependencies(file).then(function () {
                  return loader(url, version, file);
                });
              } catch (e) {
    ...
    var _default = /*#__PURE__*/function () {
      ...
      _createClass(_default, [{
        ...
        value: function _defineNamedModule(name, dependencies, factory, preventReregistration) {
          var registryElement = {};
        ...
        value: function _defineAnonymousModule(dependencies, factory, preventAutoInvoke) {
          ...
          if (!result.success && result.currentTag instanceof HTMLElement) {
            ...
            var registry = this._defineNamedModule(result.currentTag.src, dependencies, factory, true);
        ...
        key: "_setBaseUrl",
        value: function _setBaseUrl(baseUrlParam) {
          var baseUrl = "".concat(baseUrlParam).concat(baseUrlParam.endsWith('/') ? '' : '/');
