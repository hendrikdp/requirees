    ...
    _createClass(RegistryAttributes, [{
      ...
      value: function _addFile(packageName, url, version, type, dependencies, factory) {
        if (packageName) {
          ...
          if (typeof url === 'undefined') url = packageName; //get the package filetype
          ...
          this.files.push({
            ...
            url: typeof url === 'string' ? url.replace(reCleanVersionNumber, '').replace(reCleanTypePrefixOnly, '') : false,
            version: version,
            type: type,
  ...
  var _default$6 = /*#__PURE__*/function () {
    ...
    _createClass(_default, [{
      ...
      value: function shim(filetype, shimConfig) {
        ...
        var file = this.filetypes[sFiletype];
      ...
      key: "_addShimDependencies",
      value: function _addShimDependencies(file, dependencies) {
  ...
  var _default$2 = /*#__PURE__*/function () {
    ...
    _createClass(_default, [{
      ...
      value: function _resolveFactoryDependencies(resolve, version, type) {
        ...
        var dependenciesShim = versiontype.dependenciesShim instanceof Array ? versiontype.dependenciesShim : [];
        var allDependencies = dependencies.concat(dependenciesShim);
